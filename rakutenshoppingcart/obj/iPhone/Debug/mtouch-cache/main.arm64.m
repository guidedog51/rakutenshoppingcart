...
extern void *mono_aot_module_rakutenshoppingcart_info;
...
{
	mono_aot_register_module (mono_aot_module_rakutenshoppingcart_info);
...
void xamarin_setup ()
{
	...
	xamarin_executable_name = "rakutenshoppingcart.exe";
