...
//		static NSString cartItemCellId = new NSString ("CartItemCell");
		...
		public override void ViewDidLoad ()
		{
			...
			double tax = 0;
			double subtotal = 0;
			//tblCartItems.RegisterClassForCellReuse (typeof(CartItemCell), cartItemCellId);
		...
		{
//			static readonly NSString CellIdentifier = cartItemCellId;	//new NSString ("CartItemCell");
			...
			public DataSource (Cart2ViewController controller, IDataService dataService)
			{
				...
				//reg the custom cell 
				mCartTable.RegisterNibForCellReuse(UINib.FromName(CartItemCell.Key, NSBundle.MainBundle), CartItemCell.Key);
...
//			}
			...
			{
//				var cell = (CartItemCell)tableView.DequeueReusableCell (CartItemCell.Key);
